package com.ytzl.gotrip.vo.order;
...
public class ItripAddHotelOrderVO {
    ...
    private List<GotripUserLinkUser> linkUser;

    public List<GotripUserLinkUser> getLinkUser() {
        return linkUser;
    }

    public void setLinkUser(List<GotripUserLinkUser> linkUser) {
