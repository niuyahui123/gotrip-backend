package com.ytzl.gotrip.vo.comment;
...
public class ItripAddCommentVO {
    ...
    @ApiModelProperty(value = "[必填] 酒店ID")
    ...
    private GotripImage[] itripImages;
    ...
    public GotripImage[] getItripImages() {
        return itripImages;
    }

    public void setItripImages(GotripImage[] itripImages) {
